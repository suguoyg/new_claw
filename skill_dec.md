Skills 示例集
本文介绍 Anthropic 官方 Skills 仓库中的开源示例，涵盖文档处理、创意设计、技术开发等多个领域。所有示例都是生产级代码，可作为创建自定义 Skills 的参考。
...
仓库地址: github.com/anthropics/skills
...
架构设计: 理解 Skills 技术架构
社区资源 
Skills Cookbook: claude-cookbooks/skills
